      ...
      <MDBContainer className='text-center text-md-left'>
        <MDBRow className='text-center text-md-left mt-3 pb-3'>
          <MDBCol md='3' lg='3' xl='4' className='mx-auto mt-3'>
            ...
            <p>
              Get-Book is an online React web application where the customer can
          ...
          <MDBCol md='4' lg='3' xl='3' className='mx-auto mt-3'>
            ...
            <p>
              <i className='fa fa-phone mr-3' /> +91 1234334321
            </p>
            <p>
              <i className='fa fa-home mr-3' /> city, state
            </p>
          </MDBCol>
        </MDBRow>
        <hr />
        <MDBRow className='d-flex align-items-center'>
          <MDBCol md='8' lg='8'>
            <p className='text-center text-md-left grey-text'>
              ...
              <a href='https://github.com/gohar2'> Gohar </a>
            </p>
          </MDBCol>
        </MDBRow>
      </MDBContainer>
